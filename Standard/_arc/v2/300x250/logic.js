...
function animStart() {
  ...
  tl = new TimelineMax({paused:false});
    ...
    tl.addLabel('start')
         ...
         .set(creative.dom.flowLine1, {scaleX:1.5, scaleY:1.5, rotation:220}, 'start+=0.7')
         .to(creative.dom.flowLine1, 1, {backgroundPosition: "0 -2560px", ease:SteppedEase.config(16)}, 'start+=0.7')
    ...
    .addLabel('chrIntro', 1.2)        
        ...
        .set(creative.dom.flowLine2, {scaleX:1, scaleY:0.3}, 'chrIntro+=0.2')
        .to(creative.dom.flowLine2, 1, {backgroundPosition: "0 -2560px", ease:SteppedEase.config(16)}, 'chrIntro+=0.2')

    .addLabel('headLine1', 4.5)  

        .to(creative.dom.chrContainer, 0.2, {autoAlpha:0, ease: Linear.easeNone}, 'headLine1-=0.2')

        .set(creative.dom.flowLine3, {scaleX:1, scaleY:2.5, rotation: -90}, 'headLine1-=0.2')
        .to(creative.dom.flowLine3, 1, {backgroundPosition: "0 -2560px", ease:SteppedEase.config(16)}, 'headLine1-=0.2')


        .to(creative.dom.copy1, 0.4, {autoAlpha:1, ease: Linear.easeNone}, 'headLine1+=0.5')

        .set(creative.dom.flowLine4, {scaleX:1.8, scaleY:1.5, rotation:130}, 'headLine1+=1')
        .to(creative.dom.flowLine4, 1.2, {backgroundPosition: "0 -2560px", ease:SteppedEase.config(16)}, 'headLine1+=1')


        .to(creative.dom.copy2, 0.4, {autoAlpha:1, ease: Linear.easeNone}, 'headLine1+=1.8')

        .set(creative.dom.flowLine5, {scaleX:1.8, scaleY:1.5, rotation:220}, 'headLine1+=2.8')
        .to(creative.dom.flowLine5, 1, {backgroundPosition: "0 -2560px", ease:SteppedEase.config(16)}, 'headLine1+=2.8')
     ...
     .addLabel('endframe', 10) 
        ...
        .to(creative.dom.flowLine6, 1, {backgroundPosition: "0 -2560px", ease:SteppedEase.config(16)}, 'endframe-=1')

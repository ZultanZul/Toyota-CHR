...
function animStart() {
  ...
  tl = new TimelineMax({paused:false});
    ...
    tl.addLabel('start')
         ...
         .set(creative.dom.flowLine1, {scaleX:1, scaleY:1.3, rotation:45}, 'start+=0.7')
    ...
    .addLabel('chrIntro', 1.2)        
        ...
        .fromTo(creative.dom.chrCar, 1.5, {autoAlpha:0, scale:0.95}, {autoAlpha:1, scale:1, ease: Linear.easeNone}, 'chrIntro+=1.8')

        .set(creative.dom.flowLine2, {scaleX:1.6, scaleY:0.2}, 'chrIntro+=1')
    ...
    .addLabel('headLine1', 5.5)  
        ...
        .to(creative.dom.chrCar, 0.2, {autoAlpha:0, ease: Linear.easeNone}, 'headLine1-=0.2')

        .set(creative.dom.flowLine3, {scaleX:1.6, scaleY:0.7, rotation:175}, 'headLine1-=0.2')
        ...
        .set(creative.dom.flowLine4, {scaleX:1.6, scaleY:0.7, rotation:0}, 'headLine1+=1')
        ...
        .set(creative.dom.flowLine5, {scaleX:1, scaleY:1.3, rotation:45}, 'headLine1+=1')
        .to(creative.dom.flowLine5, 1, {backgroundPosition: "0 -3000px", ease:SteppedEase.config(15)}, 'headLine1+=2.65')
     ...
     .addLabel('endframe', 11) 
        ...
        .set(creative.dom.flowLine6, {scaleX:1.6, scaleY:0.7, rotation:180}, 'endframe-=0.8')
